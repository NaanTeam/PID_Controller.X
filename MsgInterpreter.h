...
#define SERIALCOMM_REGISTER_PID_ROLL_ERROR              0x9A
#define SERIALCOMM_REGISTER_PID_ROLL_ERROR_SUM          0x9B
#define SERIALCOMM_REGISTER_PID_ROLL_ERROR_DERIVATIVE   0x9C
